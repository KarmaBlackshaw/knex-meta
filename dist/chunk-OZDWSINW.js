...
var _chunkQACOCXUBjs = require('./chunk-QACOCXUB.js');


var _chunk5ZTS5JX7js = require('./chunk-5ZTS5JX7.js');


var _chunkGWDIRNHAjs = require('./chunk-GWDIRNHA.js');
...
var src_default = (knex) => {
  ...
  knex.QueryBuilder.extend(_chunkQACOCXUBjs.metaQuery.name, _chunkQACOCXUBjs.metaQuery);
  knex.QueryBuilder.extend(_chunk5ZTS5JX7js.metaSort.name, _chunk5ZTS5JX7js.metaSort);
  knex.QueryBuilder.extend(_chunkGWDIRNHAjs.metaUpdate.name, _chunkGWDIRNHAjs.metaUpdate);
  return knex;
};
